<%-- 
    Document   : busquedaHomeUsuarioDeEventos
    Created on : 29-abr-2021, 20:16:08
    Author     : David
--%>
...
<html>
    ...
    <body>
        ...
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            <input type="radio" class="btn-check" name="btn-todos" id="btnradio1" onclick="window.location = 'ServletPaginacionEventos';" autocomplete="off" checked>
        ...
        <nav aria-label="bottom-pag">
            <ul class="pagination">
                <li class="page-item <%if (pagina == 1) {%>disabled<%}%>">
                    <a class="page-link" href="ServletPaginacionEventos?pagina=<%=pagina - 1%>" tabindex="-1">Anterior</a>
                </li>
                <%
                    if (pagina == 1) {
                %>
                <li class="page-item active">
                    <a class="page-link" href="ServletPaginacionEventos?pagina=1">1 <span class="sr-only">(current)</span></a>
                </li>
                <%
                    if (!paginaFinal) {
                %>
                <li class="page-item"><a class="page-link" href="ServletPaginacionEventos?pagina=2">2</a></li>
                    <%
                        }
                    %>
                    <%
                    ...
                    %>
                <li class="page-item"><a class="page-link" href="ServletPaginacionEventos?pagina=<%=pagina - 1%>"><%=pagina - 1%></a></li>
                <li class="page-item active">
                    <a class="page-link" href="ServletPaginacionEventos?pagina=<%=pagina%>"><%=pagina%><span class="sr-only">(current)</span></a>
                </li>
                <%
                    if (!paginaFinal) {
                %>
                ...
                <li class="page-item <%if (paginaFinal) {%>disabled<%}%>">
                    <a class="page-link" href="ServletPaginacionEventos?pagina=<%=pagina + 1%>">Siguiente</a>
                </li>
            </ul>
        </nav>
