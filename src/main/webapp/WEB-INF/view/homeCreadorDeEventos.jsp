...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../../resources/static/css/homeCreadorDeEventosCSS.css">
    ...
    <body>
        ...
        <form action="ServletCreadorDeEventosListar"> 
        ...
        <table border="1" class="table table-striped text-center table-sm">
            ...
            <tr>
                ...
                <td>
                    <form action="ServletCreadorDeEventosEditarEvento?idE=<%=evento.getId()%>" method = "POST"> 
                ...
                <td>
                    <form action="ServletCreadorDeEventosBorrar?idE=<%=evento.getId()%>" method = "POST"> 
                        <button onclick="return confirm('¿Estás seguro de eliminar este evento?')" class="btn btn-danger"">Borrar </button> </a>
                    </form><br>
                </td>
            ...
            <div class="row">
                <div class="col">
                    <form action="crearEvento.jsp"> 
                        <br><input type="submit" class="btn btn-success btn-lg" value="Crear evento" name="crear_evento" />
                    </form>
                </div>
            </div>
